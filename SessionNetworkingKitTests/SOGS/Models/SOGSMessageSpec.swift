        ...
        describe("a SOGSMessage") {
            ...
            context("when decoding") {
                ...
                it("defaults the whisper values to false") {
                    ...
                    let result: Network.SOGS.Message? = try? decoder.decode(Network.SOGS.Message.self, from: messageData)
                ...
                context("and there is content") {
                    ...
                    it("errors if there is no sender") {
                        ...
                        expect {
                            try decoder.decode(Network.SOGS.Message.self, from: messageData)
                        }
