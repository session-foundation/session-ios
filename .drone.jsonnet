...
local custom_clone = {
  ...
  commands: [
    ...
    'ssh-keyscan -v -t ed25519 github.com >> $HOME/.ssh/known_hosts',
    'ssh -v -T git@github.com -i $HOME/.ssh/id_ed25519_drone_ci_deploy -F $HOME/.ssh/config -o UserKnownHostsFile=$HOME/.ssh/known_hosts',
    'git init',
