...
public extension Network.SOGS.RoomPollInfo {
    init(room: Network.SOGS.Room) {
        self.init(
            token: room.token,
...
extension Network.SOGS.RoomPollInfo {
    public init(from decoder: Decoder) throws {
        ...
        self = Network.SOGS.RoomPollInfo(
            ...
            details: try? container.decode(Network.SOGS.Room.self, forKey: .details)
        )
    }
}
