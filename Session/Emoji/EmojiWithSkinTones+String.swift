...
extension EmojiWithSkinTones {
    init?(rawValue: String) {
        ...
        switch (rawValue.unicodeScalars.map({ $0.value }).reduce(0, +) / 100) {
            ...
            case 2104: self = EmojiWithSkinTones.emojiFrom2104(rawValue)
            ...
            case 2120: self = EmojiWithSkinTones.emojiFrom2120(rawValue)
            ...
            case 2128: self = EmojiWithSkinTones.emojiFrom2128(rawValue)
            ...
            case 2645: self = EmojiWithSkinTones.emojiFrom2645(rawValue)
            case 2646: self = EmojiWithSkinTones.emojiFrom2646(rawValue)
            case 2649: self = EmojiWithSkinTones.emojiFrom2649(rawValue)
            case 2650: self = EmojiWithSkinTones.emojiFrom2650(rawValue)
            ...
            case 2943: self = EmojiWithSkinTones.emojiFrom2943(rawValue)
            case 2951: self = EmojiWithSkinTones.emojiFrom2951(rawValue)
            case 2959: self = EmojiWithSkinTones.emojiFrom2959(rawValue)
            ...
            case 3400: self = EmojiWithSkinTones.emojiFrom3400(rawValue)
            ...
            case 3408: self = EmojiWithSkinTones.emojiFrom3408(rawValue)
            case 3477: self = EmojiWithSkinTones.emojiFrom3477(rawValue)
            case 3491: self = EmojiWithSkinTones.emojiFrom3491(rawValue)
            case 3505: self = EmojiWithSkinTones.emojiFrom3505(rawValue)
            ...
            case 4048: self = EmojiWithSkinTones.emojiFrom4048(rawValue)
            case 4223: self = EmojiWithSkinTones.emojiFrom4223(rawValue)
            case 4231: self = EmojiWithSkinTones.emojiFrom4231(rawValue)
            case 4239: self = EmojiWithSkinTones.emojiFrom4239(rawValue)
            case 4771: self = EmojiWithSkinTones.emojiFrom4771(rawValue)
            case 4785: self = EmojiWithSkinTones.emojiFrom4785(rawValue)
            ...
            case 5425: self = EmojiWithSkinTones.emojiFrom5425(rawValue)
    ...
    private static func emojiFrom2104(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            "🙂‍↔️": EmojiWithSkinTones(baseEmoji: .headShakingHorizontally, skinTones: nil),
            "🙂‍↕️": EmojiWithSkinTones(baseEmoji: .headShakingVertically, skinTones: nil)
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    ...
    private static func emojiFrom2113(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            ...
            "🏃‍➡️": EmojiWithSkinTones(baseEmoji: .personRunningFacingRight, skinTones: nil),
            "🐻‍❄️": EmojiWithSkinTones(baseEmoji: .polarBear, skinTones: nil),
            "⛓️‍💥": EmojiWithSkinTones(baseEmoji: .brokenChain, skinTones: nil)
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    ...
    private static func emojiFrom2120(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            "🚶‍➡️": EmojiWithSkinTones(baseEmoji: .personWalkingFacingRight, skinTones: nil)
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    ...
    private static func emojiFrom2128(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            "🧎‍➡️": EmojiWithSkinTones(baseEmoji: .personKneelingFacingRight, skinTones: nil)
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    ...
    private static func emojiFrom2645(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            "🐦‍🔥": EmojiWithSkinTones(baseEmoji: .phoenix, skinTones: nil)
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    ...
    private static func emojiFrom2650(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            "🍋‍🟩": EmojiWithSkinTones(baseEmoji: .lime, skinTones: nil),
            "🍄‍🟫": EmojiWithSkinTones(baseEmoji: .brownMushroom, skinTones: nil)
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    ...
    private static func emojiFrom2671(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            ...
            "🧑‍🧒": EmojiWithSkinTones(baseEmoji: .familyAdultChild, skinTones: nil)
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    ...
    private static func emojiFrom2943(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            "🏃‍♀️‍➡️": EmojiWithSkinTones(baseEmoji: .womanRunningFacingRight, skinTones: nil),
            "🏃‍♂️‍➡️": EmojiWithSkinTones(baseEmoji: .manRunningFacingRight, skinTones: nil)
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    
    private static func emojiFrom2951(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            "🚶‍♀️‍➡️": EmojiWithSkinTones(baseEmoji: .womanWalkingFacingRight, skinTones: nil),
            "🚶‍♂️‍➡️": EmojiWithSkinTones(baseEmoji: .manWalkingFacingRight, skinTones: nil)
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    
    private static func emojiFrom2959(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            "🧎‍♀️‍➡️": EmojiWithSkinTones(baseEmoji: .womanKneelingFacingRight, skinTones: nil),
            "🧎‍♂️‍➡️": EmojiWithSkinTones(baseEmoji: .manKneelingFacingRight, skinTones: nil)
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    ...
    private static func emojiFrom3393(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            ...
            "🏃🏻‍➡️": EmojiWithSkinTones(baseEmoji: .personRunningFacingRight, skinTones: [.light]),
            ...
            "🏃🏼‍➡️": EmojiWithSkinTones(baseEmoji: .personRunningFacingRight, skinTones: [.mediumLight]),
            "👨🏽‍✈️": EmojiWithSkinTones(baseEmoji: .malePilot, skinTones: [.medium]),
            "👩🏽‍✈️": EmojiWithSkinTones(baseEmoji: .femalePilot, skinTones: [.medium]),
            "🏃🏽‍➡️": EmojiWithSkinTones(baseEmoji: .personRunningFacingRight, skinTones: [.medium]),
            ...
            "🏃🏾‍➡️": EmojiWithSkinTones(baseEmoji: .personRunningFacingRight, skinTones: [.mediumDark]),
            "👨🏿‍✈️": EmojiWithSkinTones(baseEmoji: .malePilot, skinTones: [.dark]),
            "👩🏿‍✈️": EmojiWithSkinTones(baseEmoji: .femalePilot, skinTones: [.dark]),
            "🏃🏿‍➡️": EmojiWithSkinTones(baseEmoji: .personRunningFacingRight, skinTones: [.dark])
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    ...
    private static func emojiFrom3400(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            "🚶🏻‍➡️": EmojiWithSkinTones(baseEmoji: .personWalkingFacingRight, skinTones: [.light]),
            "🚶🏼‍➡️": EmojiWithSkinTones(baseEmoji: .personWalkingFacingRight, skinTones: [.mediumLight]),
            "🚶🏽‍➡️": EmojiWithSkinTones(baseEmoji: .personWalkingFacingRight, skinTones: [.medium]),
            "🚶🏾‍➡️": EmojiWithSkinTones(baseEmoji: .personWalkingFacingRight, skinTones: [.mediumDark]),
            "🚶🏿‍➡️": EmojiWithSkinTones(baseEmoji: .personWalkingFacingRight, skinTones: [.dark])
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    ...
    private static func emojiFrom3408(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            "🧎🏻‍➡️": EmojiWithSkinTones(baseEmoji: .personKneelingFacingRight, skinTones: [.light]),
            "🧎🏼‍➡️": EmojiWithSkinTones(baseEmoji: .personKneelingFacingRight, skinTones: [.mediumLight]),
            "🧎🏽‍➡️": EmojiWithSkinTones(baseEmoji: .personKneelingFacingRight, skinTones: [.medium]),
            "🧎🏾‍➡️": EmojiWithSkinTones(baseEmoji: .personKneelingFacingRight, skinTones: [.mediumDark]),
            "🧎🏿‍➡️": EmojiWithSkinTones(baseEmoji: .personKneelingFacingRight, skinTones: [.dark])
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    ...
    private static func emojiFrom3491(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            "👨‍🦯‍➡️": EmojiWithSkinTones(baseEmoji: .manWithWhiteCaneFacingRight, skinTones: nil),
            "👩‍🦯‍➡️": EmojiWithSkinTones(baseEmoji: .womanWithWhiteCaneFacingRight, skinTones: nil),
            "👨‍🦼‍➡️": EmojiWithSkinTones(baseEmoji: .manInMotorizedWheelchairFacingRight, skinTones: nil),
            "👩‍🦼‍➡️": EmojiWithSkinTones(baseEmoji: .womanInMotorizedWheelchairFacingRight, skinTones: nil),
            "👨‍🦽‍➡️": EmojiWithSkinTones(baseEmoji: .manInManualWheelchairFacingRight, skinTones: nil),
            "👩‍🦽‍➡️": EmojiWithSkinTones(baseEmoji: .womanInManualWheelchairFacingRight, skinTones: nil)
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    
    private static func emojiFrom3505(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            "🧑‍🦯‍➡️": EmojiWithSkinTones(baseEmoji: .personWithWhiteCaneFacingRight, skinTones: nil),
            "🧑‍🦼‍➡️": EmojiWithSkinTones(baseEmoji: .personInMotorizedWheelchairFacingRight, skinTones: nil),
            "🧑‍🦽‍➡️": EmojiWithSkinTones(baseEmoji: .personInManualWheelchairFacingRight, skinTones: nil)
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    ...
    private static func emojiFrom4048(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            "🧑‍🧑‍🧒": EmojiWithSkinTones(baseEmoji: .familyAdultAdultChild, skinTones: nil),
            "🧑‍🧒‍🧒": EmojiWithSkinTones(baseEmoji: .familyAdultChildChild, skinTones: nil)
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    
    private static func emojiFrom4223(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            "🏃🏻‍♀️‍➡️": EmojiWithSkinTones(baseEmoji: .womanRunningFacingRight, skinTones: [.light]),
            "🏃🏻‍♂️‍➡️": EmojiWithSkinTones(baseEmoji: .manRunningFacingRight, skinTones: [.light]),
            "🏃🏼‍♀️‍➡️": EmojiWithSkinTones(baseEmoji: .womanRunningFacingRight, skinTones: [.mediumLight]),
            "🏃🏼‍♂️‍➡️": EmojiWithSkinTones(baseEmoji: .manRunningFacingRight, skinTones: [.mediumLight]),
            "🏃🏽‍♀️‍➡️": EmojiWithSkinTones(baseEmoji: .womanRunningFacingRight, skinTones: [.medium]),
            "🏃🏽‍♂️‍➡️": EmojiWithSkinTones(baseEmoji: .manRunningFacingRight, skinTones: [.medium]),
            "🏃🏾‍♀️‍➡️": EmojiWithSkinTones(baseEmoji: .womanRunningFacingRight, skinTones: [.mediumDark]),
            "🏃🏾‍♂️‍➡️": EmojiWithSkinTones(baseEmoji: .manRunningFacingRight, skinTones: [.mediumDark]),
            "🏃🏿‍♀️‍➡️": EmojiWithSkinTones(baseEmoji: .womanRunningFacingRight, skinTones: [.dark]),
            "🏃🏿‍♂️‍➡️": EmojiWithSkinTones(baseEmoji: .manRunningFacingRight, skinTones: [.dark])
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    
    private static func emojiFrom4231(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            "🚶🏻‍♀️‍➡️": EmojiWithSkinTones(baseEmoji: .womanWalkingFacingRight, skinTones: [.light]),
            "🚶🏻‍♂️‍➡️": EmojiWithSkinTones(baseEmoji: .manWalkingFacingRight, skinTones: [.light]),
            "🚶🏼‍♀️‍➡️": EmojiWithSkinTones(baseEmoji: .womanWalkingFacingRight, skinTones: [.mediumLight]),
            "🚶🏼‍♂️‍➡️": EmojiWithSkinTones(baseEmoji: .manWalkingFacingRight, skinTones: [.mediumLight]),
            "🚶🏽‍♀️‍➡️": EmojiWithSkinTones(baseEmoji: .womanWalkingFacingRight, skinTones: [.medium]),
            "🚶🏽‍♂️‍➡️": EmojiWithSkinTones(baseEmoji: .manWalkingFacingRight, skinTones: [.medium]),
            "🚶🏾‍♀️‍➡️": EmojiWithSkinTones(baseEmoji: .womanWalkingFacingRight, skinTones: [.mediumDark]),
            "🚶🏾‍♂️‍➡️": EmojiWithSkinTones(baseEmoji: .manWalkingFacingRight, skinTones: [.mediumDark]),
            "🚶🏿‍♀️‍➡️": EmojiWithSkinTones(baseEmoji: .womanWalkingFacingRight, skinTones: [.dark]),
            "🚶🏿‍♂️‍➡️": EmojiWithSkinTones(baseEmoji: .manWalkingFacingRight, skinTones: [.dark])
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    
    private static func emojiFrom4239(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            "🧎🏻‍♀️‍➡️": EmojiWithSkinTones(baseEmoji: .womanKneelingFacingRight, skinTones: [.light]),
            "🧎🏻‍♂️‍➡️": EmojiWithSkinTones(baseEmoji: .manKneelingFacingRight, skinTones: [.light]),
            "🧎🏼‍♀️‍➡️": EmojiWithSkinTones(baseEmoji: .womanKneelingFacingRight, skinTones: [.mediumLight]),
            "🧎🏼‍♂️‍➡️": EmojiWithSkinTones(baseEmoji: .manKneelingFacingRight, skinTones: [.mediumLight]),
            "🧎🏽‍♀️‍➡️": EmojiWithSkinTones(baseEmoji: .womanKneelingFacingRight, skinTones: [.medium]),
            "🧎🏽‍♂️‍➡️": EmojiWithSkinTones(baseEmoji: .manKneelingFacingRight, skinTones: [.medium]),
            "🧎🏾‍♀️‍➡️": EmojiWithSkinTones(baseEmoji: .womanKneelingFacingRight, skinTones: [.mediumDark]),
            "🧎🏾‍♂️‍➡️": EmojiWithSkinTones(baseEmoji: .manKneelingFacingRight, skinTones: [.mediumDark]),
            "🧎🏿‍♀️‍➡️": EmojiWithSkinTones(baseEmoji: .womanKneelingFacingRight, skinTones: [.dark]),
            "🧎🏿‍♂️‍➡️": EmojiWithSkinTones(baseEmoji: .manKneelingFacingRight, skinTones: [.dark])
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    
    private static func emojiFrom4771(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            "👨🏻‍🦯‍➡️": EmojiWithSkinTones(baseEmoji: .manWithWhiteCaneFacingRight, skinTones: [.light]),
            "👩🏻‍🦯‍➡️": EmojiWithSkinTones(baseEmoji: .womanWithWhiteCaneFacingRight, skinTones: [.light]),
            "👨🏻‍🦼‍➡️": EmojiWithSkinTones(baseEmoji: .manInMotorizedWheelchairFacingRight, skinTones: [.light]),
            "👩🏻‍🦼‍➡️": EmojiWithSkinTones(baseEmoji: .womanInMotorizedWheelchairFacingRight, skinTones: [.light]),
            "👨🏻‍🦽‍➡️": EmojiWithSkinTones(baseEmoji: .manInManualWheelchairFacingRight, skinTones: [.light]),
            "👩🏻‍🦽‍➡️": EmojiWithSkinTones(baseEmoji: .womanInManualWheelchairFacingRight, skinTones: [.light]),
            "👨🏼‍🦯‍➡️": EmojiWithSkinTones(baseEmoji: .manWithWhiteCaneFacingRight, skinTones: [.mediumLight]),
            "👩🏼‍🦯‍➡️": EmojiWithSkinTones(baseEmoji: .womanWithWhiteCaneFacingRight, skinTones: [.mediumLight]),
            "👨🏼‍🦼‍➡️": EmojiWithSkinTones(baseEmoji: .manInMotorizedWheelchairFacingRight, skinTones: [.mediumLight]),
            "👩🏼‍🦼‍➡️": EmojiWithSkinTones(baseEmoji: .womanInMotorizedWheelchairFacingRight, skinTones: [.mediumLight]),
            "👨🏼‍🦽‍➡️": EmojiWithSkinTones(baseEmoji: .manInManualWheelchairFacingRight, skinTones: [.mediumLight]),
            "👩🏼‍🦽‍➡️": EmojiWithSkinTones(baseEmoji: .womanInManualWheelchairFacingRight, skinTones: [.mediumLight]),
            "👨🏽‍🦯‍➡️": EmojiWithSkinTones(baseEmoji: .manWithWhiteCaneFacingRight, skinTones: [.medium]),
            "👩🏽‍🦯‍➡️": EmojiWithSkinTones(baseEmoji: .womanWithWhiteCaneFacingRight, skinTones: [.medium]),
            "👨🏽‍🦼‍➡️": EmojiWithSkinTones(baseEmoji: .manInMotorizedWheelchairFacingRight, skinTones: [.medium]),
            "👩🏽‍🦼‍➡️": EmojiWithSkinTones(baseEmoji: .womanInMotorizedWheelchairFacingRight, skinTones: [.medium]),
            "👨🏽‍🦽‍➡️": EmojiWithSkinTones(baseEmoji: .manInManualWheelchairFacingRight, skinTones: [.medium]),
            "👩🏽‍🦽‍➡️": EmojiWithSkinTones(baseEmoji: .womanInManualWheelchairFacingRight, skinTones: [.medium]),
            "👨🏾‍🦯‍➡️": EmojiWithSkinTones(baseEmoji: .manWithWhiteCaneFacingRight, skinTones: [.mediumDark]),
            "👩🏾‍🦯‍➡️": EmojiWithSkinTones(baseEmoji: .womanWithWhiteCaneFacingRight, skinTones: [.mediumDark]),
            "👨🏾‍🦼‍➡️": EmojiWithSkinTones(baseEmoji: .manInMotorizedWheelchairFacingRight, skinTones: [.mediumDark]),
            "👩🏾‍🦼‍➡️": EmojiWithSkinTones(baseEmoji: .womanInMotorizedWheelchairFacingRight, skinTones: [.mediumDark]),
            "👨🏾‍🦽‍➡️": EmojiWithSkinTones(baseEmoji: .manInManualWheelchairFacingRight, skinTones: [.mediumDark]),
            "👩🏾‍🦽‍➡️": EmojiWithSkinTones(baseEmoji: .womanInManualWheelchairFacingRight, skinTones: [.mediumDark]),
            "👨🏿‍🦯‍➡️": EmojiWithSkinTones(baseEmoji: .manWithWhiteCaneFacingRight, skinTones: [.dark]),
            "👩🏿‍🦯‍➡️": EmojiWithSkinTones(baseEmoji: .womanWithWhiteCaneFacingRight, skinTones: [.dark]),
            "👨🏿‍🦼‍➡️": EmojiWithSkinTones(baseEmoji: .manInMotorizedWheelchairFacingRight, skinTones: [.dark]),
            "👩🏿‍🦼‍➡️": EmojiWithSkinTones(baseEmoji: .womanInMotorizedWheelchairFacingRight, skinTones: [.dark]),
            "👨🏿‍🦽‍➡️": EmojiWithSkinTones(baseEmoji: .manInManualWheelchairFacingRight, skinTones: [.dark]),
            "👩🏿‍🦽‍➡️": EmojiWithSkinTones(baseEmoji: .womanInManualWheelchairFacingRight, skinTones: [.dark])
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    
    private static func emojiFrom4785(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            "🧑🏻‍🦯‍➡️": EmojiWithSkinTones(baseEmoji: .personWithWhiteCaneFacingRight, skinTones: [.light]),
            "🧑🏻‍🦼‍➡️": EmojiWithSkinTones(baseEmoji: .personInMotorizedWheelchairFacingRight, skinTones: [.light]),
            "🧑🏻‍🦽‍➡️": EmojiWithSkinTones(baseEmoji: .personInManualWheelchairFacingRight, skinTones: [.light]),
            "🧑🏼‍🦯‍➡️": EmojiWithSkinTones(baseEmoji: .personWithWhiteCaneFacingRight, skinTones: [.mediumLight]),
            "🧑🏼‍🦼‍➡️": EmojiWithSkinTones(baseEmoji: .personInMotorizedWheelchairFacingRight, skinTones: [.mediumLight]),
            "🧑🏼‍🦽‍➡️": EmojiWithSkinTones(baseEmoji: .personInManualWheelchairFacingRight, skinTones: [.mediumLight]),
            "🧑🏽‍🦯‍➡️": EmojiWithSkinTones(baseEmoji: .personWithWhiteCaneFacingRight, skinTones: [.medium]),
            "🧑🏽‍🦼‍➡️": EmojiWithSkinTones(baseEmoji: .personInMotorizedWheelchairFacingRight, skinTones: [.medium]),
            "🧑🏽‍🦽‍➡️": EmojiWithSkinTones(baseEmoji: .personInManualWheelchairFacingRight, skinTones: [.medium]),
            "🧑🏾‍🦯‍➡️": EmojiWithSkinTones(baseEmoji: .personWithWhiteCaneFacingRight, skinTones: [.mediumDark]),
            "🧑🏾‍🦼‍➡️": EmojiWithSkinTones(baseEmoji: .personInMotorizedWheelchairFacingRight, skinTones: [.mediumDark]),
            "🧑🏾‍🦽‍➡️": EmojiWithSkinTones(baseEmoji: .personInManualWheelchairFacingRight, skinTones: [.mediumDark]),
            "🧑🏿‍🦯‍➡️": EmojiWithSkinTones(baseEmoji: .personWithWhiteCaneFacingRight, skinTones: [.dark]),
            "🧑🏿‍🦼‍➡️": EmojiWithSkinTones(baseEmoji: .personInMotorizedWheelchairFacingRight, skinTones: [.dark]),
            "🧑🏿‍🦽‍➡️": EmojiWithSkinTones(baseEmoji: .personInManualWheelchairFacingRight, skinTones: [.dark])
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
    ...
    private static func emojiFrom5425(_ rawValue: String) -> EmojiWithSkinTones {
        let lookup: [String: EmojiWithSkinTones] = [
            "🧑‍🧑‍🧒‍🧒": EmojiWithSkinTones(baseEmoji: .familyAdultAdultChildChild, skinTones: nil)
        ]
        return (lookup[rawValue] ?? EmojiWithSkinTones(unsupportedValue: rawValue))
    }
