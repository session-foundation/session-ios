...
public class DonationsManager {
    public static let modalVariant: DonationCTAModal.Variant = .ongoingAppeal
    ...
    private static let donationTriggersResetDate: Date = Date(timeIntervalSince1970: 1783296000)
