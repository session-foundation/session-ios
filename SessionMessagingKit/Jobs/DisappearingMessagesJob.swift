...
public enum DisappearingMessagesJob: JobExecutor {
    ...
    public static func run<S: Scheduler>(
        ...
        let timestampNowMs: Double = dependencies[cache: .storageServer].currentOffsetTimestampMs()
...
public extension DisappearingMessagesJob {
    @discardableResult static func updateNextRunIfNeeded(
        ...
        let clockOffsetMs: Int64 = dependencies[cache: .storageServer].clockOffsetMs
