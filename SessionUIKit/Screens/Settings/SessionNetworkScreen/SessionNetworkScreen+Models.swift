...
public extension SessionNetworkScreenContent {
    ...
    final class DataModel: Equatable {
        ...
        public var tokenUSDString: String {
            ...
            return "$\(tokenUSD.formatted(format: .currency(decimal: true, withLocalSymbol: false))) USD"
        }
        public var tokenUSDNoCentsString: String {
            guard let tokenUSD: Double = tokenUSD else {
                return "unavailable".localized()
            }
            return "$\(tokenUSD.formatted(format: .currency(decimal: false, withLocalSymbol: false))) USD"
        }
        ...
        public var networkStakedUSDString: String {
            ...
            return "$\(networkStakedUSD.formatted(format: .currency(decimal: false, withLocalSymbol: false))) USD"
        }
        ...
        public var marketCapString: String {
            ...
            return "$\(marketCap.formatted(format: .currency(decimal: false, withLocalSymbol: false))) USD"
        }
