...
public extension DonationCTAModal.Variant {
    ...
    var title: ThemedAttributedString {
        switch self {
            ...
            case .appeal:
                return "<span>Please Read:</span><br/>A Personal Appeal From Cofounder of Session Chris McCabe"
                    .localizedFormatted(baseFont: Fonts.Headings.H4)
        }
    }
    ...
    var message: ThemedAttributedString {
        switch self {
            ...
            case .appeal:
                return "Eight years ago, Session was founded with a mission to restore your privacy. Today Session faces a funding shortage which puts it’s very survival at risk.<br/><br/>If you’ve ever found value in Session or its mission, please give me a moment of your time and read this appeal."
                    .localizedFormatted(baseFont: Fonts.Body.largeRegular)
        }
    }
    ...
    var confirmTitle: String {
        switch self {
            ...
            case .appeal: return "Read Appeal"
        }
    }
